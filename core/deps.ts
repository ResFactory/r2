...
export * as io from "https://deno.land/std@0.137.0/io/mod.ts";
export * as log from "https://deno.land/std@0.137.0/log/mod.ts";
export * as path from "https://deno.land/std@0.137.0/path/mod.ts";
export * as yaml from "https://deno.land/std@0.137.0/encoding/yaml.ts";
export * as toml from "https://deno.land/std@0.137.0/encoding/toml.ts";
