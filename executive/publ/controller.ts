...
import * as psds from "./publication-db.auto.govn.ts";
      ...
      produceOperationalCtxCargo: async (home) => {
        ...
        if (isExperimentalOperationalCtx) {
          await Deno.writeTextFile(
            ...
            // Generated by ${import.meta.url}. DO NOT EDIT.
            /**
             ...
             *
             * This file is generated for use by server.auto.mjs.
             */
            ...
            export * from "../../../../../github.com/resFactory/factory/lib/text/human.ts";
            export * from "../../../../../github.com/resFactory/factory/executive/publ/server/middleware/workspace/ua-editable.ts";
            `),
          );
