...
export function fileSystemModels<Context extends SQLa.SqlEmitContext>(
  ...
  // TODO: add fs_walk_state or similar to capture the file size, checksums, modf dates, etc.
  //       this allows `fs_entry_file` to be append-only immutable but the `fs_entry_walk_state` can indicate changes over time
